...
export class AddNewCategoryComponent implements OnInit {
  ...
  constructor(private dialogRef:DialogRef,@Inject(DIALOG_DATA) private dialogData:{products:any[],noSave:boolean,mode:'add'|'edit',category:Category,rootProducts?:any[]},private dataProvider:DataProvider,private alertify:AlertsAndNotificationsService,private menuManagementService:MenuManagementService){
