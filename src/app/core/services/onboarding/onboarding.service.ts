  ...
  async startVrajera(business: BusinessRecord) {
    ...
    docData(
      ...
      if (res) {
        ...
        this.dataProvider.allowUnverifiedRePrint = res['allowUnverifiedRePrint'] || false;
        this.dataProvider.availLoyaltyDefault = res['availLoyaltyDefault'] || false;
        this.dataProvider.quickReasons = res['quickReasons'] || [];
