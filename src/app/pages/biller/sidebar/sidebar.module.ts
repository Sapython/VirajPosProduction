...
import { DaySummaryComponent } from './reports/report-view/day-summary/day-summary.component';
import { DineInBillsComponent } from './reports/report-view/dine-in-bills/dine-in-bills.component';
import { TakeawayBillsComponent } from './reports/report-view/takeaway-bills/takeaway-bills.component';
import { OnlineBillsComponent } from './reports/report-view/online-bills/online-bills.component';
import { KotWiseReportComponent } from './reports/report-view/kot-wise-report/kot-wise-report.component';
import { ItemWiseReportComponent } from './reports/report-view/item-wise-report/item-wise-report.component';
import { DiscountedBillsComponent } from './reports/report-view/discounted-bills/discounted-bills.component';
import { NonChargeableBillsComponent } from './reports/report-view/non-chargeable-bills/non-chargeable-bills.component';
import { BillEditsComponent } from './reports/report-view/bill-edits/bill-edits.component';
import { CustomerWiseReportComponent } from './reports/report-view/customer-wise-report/customer-wise-report.component';
import { HourlyItemSalesComponent } from './reports/report-view/hourly-item-sales/hourly-item-sales.component';
import { KotEditsComponent } from './reports/report-view/kot-edits/kot-edits.component';
import { PaymentWiseComponent } from './reports/report-view/payment-wise/payment-wise.component';
import { WaiterWiseItemsComponent } from './reports/report-view/waiter-wise-items/waiter-wise-items.component';
import { BillWiseComponent } from './reports/report-view/bill-wise/bill-wise.component';
import { ConsolidatedComponent } from './reports/report-view/consolidated/consolidated.component';
import { TableWiseComponent } from './reports/report-view/table-wise/table-wise.component';
import { DiscountedBillsPipe } from './reports/report-view/discounted-bills.pipe';
import { ComboComponent } from './reports/report-view/combo/combo.component';
import { TableMergesComponent } from './reports/report-view/table-merges/table-merges.component';
import { TableExchangesComponent } from './reports/report-view/table-exchanges/table-exchanges.component';
import { TableSplitsComponent } from './reports/report-view/table-splits/table-splits.component';
import { SplitBillsComponent } from './reports/report-view/split-bills/split-bills.component';
...
import { SettledBillsComponent } from './reports/report-view/settled-bills/settled-bills.component';
