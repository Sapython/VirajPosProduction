...
import { AccessGroup } from '../add/add.component';
...
export class UpdateComponent implements OnInit {
  ...
  constructor(public dataProvider:DataProvider,public dialogRef:DialogRef,@Inject(DIALOG_DATA) public user:Member){}
  ngOnInit(): void {
